...
function Footer() {
  return (
    <div className="flex flex-wrap p-10 bg-black text-xl mt-auto text-white font-comfortaa b-0 inset-x-0  bottom-0 items-center place-content-evenly overflow-hidden ">
      <iframe
